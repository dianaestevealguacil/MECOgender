...
- "supp texts.xlsx"/"supp texts.csv": the texts presented in the eye-tracking reading task in each of the different sites. 
- "comp-questions.xlsx": comprehension used after each of the 12 texts in each site (in different tabs). 1/0 in columns a1-a4 stands for correct/incorrect as an expected response.
